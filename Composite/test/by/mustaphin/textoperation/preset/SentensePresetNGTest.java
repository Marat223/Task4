 ...
 * @author me
 */
public class SentensePresetNGTest {

    public SentensePresetNGTest() {
    }
    ...
    /**
     * Тест метод getRegularExpression, класса SentensePreset.
     */
    @Test
    public void testGetRegularExpression() {
	System.out.println("getRegularExpression");
	SentensePreset instance = null;
	String expResult = "";
    ...
    /**
     * Тест метод assembly, класса SentensePreset.
     */
    @Test
